    ...
    return (
        <div id="tttab">
            ...
            style={{
               ...
               className="nav" fill justify variant="pills" defaultActiveKey="All">
                <Nav.Item id="navitem1">
                    <Nav.Link 
                     style={{
                       color: "white",
                      }}
                      onClick ={() => { setTab(0) }} eventKey="All">전체</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem2">
                    ...
                    onClick ={() => { setTab(1) }} eventKey="Pitcher">투수</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem3">
                    <Nav.Link
                    style={{
                       color: "white",
                      }} onClick ={() => { setTab(2) }} eventKey="Catcher">포수</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem4">
                    <Nav.Link
                    style={{
                       color: "white",
                      }} onClick ={() => { setTab(3) }} eventKey="Infielder">내야수</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem5">
                    <Nav.Link
                    style={{
                       color: "white",
                      }} onClick ={() => { setTab(4) }} eventKey="Outfielder">외야수</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem6">
                    <Nav.Link
                    style={{
                       color: "white",
                      }} onClick ={() => { setTab(5) }} eventKey="Newbie">신인선수</Nav.Link>
                </Nav.Item>
                <Nav.Item id="navitem7">
                    <Nav.Link
                    style={{
                       color: "white",
                      }} onClick ={() => { setTab(6) }} eventKey="Arm">군입대선수</Nav.Link>
                </Nav.Item>
            </Nav>
